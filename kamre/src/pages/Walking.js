            ...
            <IonContent fullscreen class={"ion-padding-horizontal"}>
                ...
                <div>
                    <IonList class="ion-text-wrap">
                        ...
                        <IonItem>
                            <IonLabel className="ion-text-wrap">3. Gdy już to zrobisz, wybierz kierunek - lewo, prawo, może prosto?</IonLabel>
                        </IonItem>
                        <IonItem>
                            <IonLabel className="ion-text-wrap">4. W trakcie spaceru skup się na tym co słyszysz, widzisz, czujesz. Daj swoim emocjom Cię ponieść.</IonLabel>
                        </IonItem>
                        <IonItem>
